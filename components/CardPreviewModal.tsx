...
export function CardPreviewModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-[rgba(2,8,23,0.82)] p-6 backdrop-blur-xl"
      style={{
        position: "fixed",
        inset: 0,
        zIndex: 50,
    ...
    >
      <section
        className="relative my-auto max-h-[94vh] w-[min(96vw,860px)] overflow-y-auto overflow-x-hidden rounded-[24px] border border-blue-300/35 bg-[rgba(3,12,32,0.96)] p-5 shadow-[0_0_96px_rgba(37,99,235,0.48)]"
        style={{
          position: "relative",
      ...
      >
        ...
        <div className="sticky top-0 z-20 -mx-1 mb-4 flex flex-col gap-4 rounded-2xl border border-blue-200/15 bg-[rgba(3,12,32,0.9)] p-3 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <div className="flex flex-wrap gap-2" data-no-capture="true">
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-cyan-100/40 bg-blue-500 px-4 text-sm font-semibold text-white shadow-[0_0_36px_rgba(59,130,246,0.5)] transition hover:-translate-y-0.5 hover:bg-cyan-400 disabled:cursor-not-allowed disabled:opacity-60"
            >
